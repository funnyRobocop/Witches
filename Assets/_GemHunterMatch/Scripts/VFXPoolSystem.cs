...
namespace Match3
{
    public class VFXPoolSystem
    {
        ...
        {
            public GameObject Instance; //Todo
            public int FrameCount;
        }

        private Dictionary<GameObject, Queue<VFXInstance>> m_Lookup = new();
        ...
        public void AddNewInstance(GameObject prefab, int count)
        {
        ...
        public ParticleSystem PlayInstanceAt(GameObject prefab, Vector3 position)
        {
        ...
        public ParticleSystem GetInstance(GameObject prefab)
        {
            ...
            return inst.Instance.GetComponent<ParticleSystem>();
        }
    }
}
